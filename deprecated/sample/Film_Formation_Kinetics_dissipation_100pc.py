...
Time = vector(Time)
Frequency_Change = exampledata2[4527:,3]
Baseline= statistics.mean(exampledata2[4512:4527,3])
Frequency_Change = Frequency_Change - Baseline
Surface_Density = Frequency_Change*1000000
...
ax.scatter(Time,Surface_Density,color='r',marker='o',label='100% Nontreated SF',facecolors='none')
...
Time = vector(Time)
Frequency_Change = exampledata2[2549:,3]
Baseline= statistics.mean(exampledata2[2534:2549,3])
Frequency_Change = Frequency_Change - Baseline
Surface_Density = Frequency_Change*1000000
Surface_Density= vector(Surface_Density)
Time=Time[0::100]
...
ax.scatter(Time,Surface_Density,color='k',marker='o',label= '100% SF+HAase',facecolors='none')
...
Time = vector(Time)
Frequency_Change = exampledata2[3927:,3]
Baseline= statistics.mean(exampledata2[3912:3927,3])
Frequency_Change = Frequency_Change - Baseline
Surface_Density = (Frequency_Change)*1000000
Surface_Density= vector(Surface_Density)
...
ax.scatter(Time,Surface_Density,color='b',marker='o',label= '100% SF+Trypsin',facecolors='none')
...
ax.set_ylabel("Change in dissipation,\n $\Delta$$d$ (10\u207b\u2076)",color="black",fontsize=14)
...
fig.savefig('Film_Formation_Kinetics_dissipation_100pc.pdf',
                        format='pdf',
                        dpi=100,
                        bbox_inches='tight')
# #Define Constants
